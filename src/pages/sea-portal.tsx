        ...
        >
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground text-justify leading-loose">
                The SEA Portal is a centralized platform for Cal Poly Pomona
                students to register as members of the{" "}
                <b>Software Engineering Association (SEA)</b> and access club
                resources. It replaces scattered documents and forgotten
                spreadsheets with a structured database that gives the e-board
                clear visibility into membership, attendance, event planning,
                and student needs. By integrating and automating redundant
                tasks, the portal streamlines operations, reduces manual
                workload, and ensures no information is lost during e-board
                transitions. This creates continuity, stability, and long-term
                reliability for the club.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-sm leading-loose justify-center">
              SEA struggled with scattered spreadsheets, missing documents, and
              inconsistent handoffs between yearly e-board teams. Important data
              about members, attendance, and interests was often lost, which
              forced new boards to collect the same information again. Without
              centralized records, the club had no clear metrics or insights to
              guide decisions.
            </p>
          </div>
          ...
          >
            ...
            <br />
            <p className="text-sm leading-loose justify-center">
              The project was built using Supabase for the database and
              authentication, React Router and Shadcn UI for the portal
              interface, and Tableau with dbt for analytics. This environment
              allowed the system to support member registration, e-board logins,
              event creation, and self-service dashboards that visualize
              participation and interest trends.
            </p>
          </div>
          ...
          >
            ...
            <ul className="list-disc pl-4 space-y-1 text-md">
              <li>
                Designed a unified database for members, events, attendance, and
                interests.
              </li>
              <li>
                Built a registration portal for students and a management
                dashboard for the e-board.
              </li>
              <li>
                Integrated analytics with Tableau and dbt for real time insights
                from Supabase.
              </li>
              <li>
                Replaced multiple spreadsheets with automated data collection
                and centralized storage.
              </li>
              <li>
                Created persistent systems so future e-boards inherit complete
                historical data.
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <p className="text-sm leading-relaxed">
              {" "}
              I designed the SEA Portal by first creating a normalized
              relational schema in Supabase that serves as the central source of
              truth for all club data. This included tables for members, events,
              attendance, interests, and participation records. I established
              foreign keys, indexing strategies, and role-based access rules
              that separate general members from e-board privileges. The
              database structure was built to ensure that historical information
              remains intact during each yearly transition of officers.{" "}
            </p>
          </div>
          ...
          >
            ...
            <ul className="list-disc pl-4 space-y-1 text-sm">
              <li>
                Gained experience designing systems that survive leadership
                turnover.
              </li>
              <li>
                Learned how to integrate a full data stack from database to
                dashboard.
              </li>
              <li>
                Strengthened skills in building maintainable systems for real
                organizations.
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <p className="text-sm leading-relaxed">
              {" "}
              On the application side, I implemented the frontend in React using
              React Router to support different user flows for members and board
              officers. I integrated Supabase Auth to provide secure onboarding
              and login features. I used Shadcn UI components to build a clean
              and accessible interface. New members can register, update their
              information, and view upcoming events, while board members can log
              in to manage events, track participation, and review operational
              data through a structured dashboard. This replaced the
              inconsistent set of Google Sheets and Discord forms the club
              relied on.{" "}
            </p>
            <br />
          </div>
          ...
          >
            ...
            <p className="text-sm leading-relaxed">
              {" "}
              For analytics, I built a pipeline using dbt and Tableau. I created
              dbt models that transform raw operational data into metrics such
              as attendance trends, retention statistics, and participation
              rates. Tableau dashboards connect directly to these models, giving
              the board real time insights without any manual data cleanup. This
              allowed officers to track performance and identify areas to
              improve programming and outreach.{" "}
            </p>
          </div>
