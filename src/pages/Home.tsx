    ...
    <section>
      {rowHeight !== null && (
        ...
        >
          ...
          <div key="spacer-3" className="pointer-events-none select-none">
            {/* empty on purpose */}
          </div>
          ...
          >
            ...
            <p className="text-xs">
              ...
              pipelines to internal tools that streamline operations and
              automate workflows.
            </p>
          </div>
          ...
          <div key="block-2" className="relative w-full h-full">
            ...
            >
              <h1 className="text-2xl font-black font-poppins mb-4">
                NASA ETL PIPELINE
              </h1>
            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-sm text-justify leading-relaxed">
                  ...
                  transparency, organization, and decision-making for future
                  boards.
                </p>
              </div>
          ...
          <div key="block-7" className="relative w-full h-full">
            ...
            >
              ...
              >
                <a
                  href="https://github.com/MarcCruzs/ODLC_Machine_Inferencing_System"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Github
          ...
          >
            ...
            <p className="text-sm leading-relaxed max-w-md">
              I’m open to collaborating on software engineering and data
              engineering work. From backend systems and ETL pipelines to
              internal tools that support teams.
            </p>
          </div>
